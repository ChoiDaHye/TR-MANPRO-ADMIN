...
public class Customer_add extends javax.swing.JFrame {
    ...
    void customer_tambah(String ktp, String nama, String kontak, String alamat, String user, String pass){
        try {
    ...
    private void initComponents() {
        ...
        regis_txt_ktp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                regis_txt_ktpActionPerformed(evt);
            }
        });
        ...
        regis_txt_kontak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                regis_txt_kontakActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {regis_txt_alamat, regis_txt_kontak, regis_txt_ktp, regis_txt_nama, regis_txt_password, regis_txt_username});
    ...
    private void regis_txt_ktpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regis_txt_ktpActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_regis_txt_ktpActionPerformed

    private void regis_txt_kontakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regis_txt_kontakActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_regis_txt_kontakActionPerformed

    private void regis_btn_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_regis_btn_simpanMouseClicked
        String ktp = regis_txt_ktp.getText(), nama = regis_txt_nama.getText(), kontak = regis_txt_kontak.getText(), alamat = regis_txt_alamat.getText(), user = regis_txt_username.getText(), pass = regis_txt_password.getText();

        if (ktp.isEmpty() || nama.isEmpty() || kontak.isEmpty() || alamat.isEmpty() || user.isEmpty() || pass.isEmpty()) {
            ...
            if (selection == JOptionPane.OK_OPTION) {
                customer_tambah(ktp, nama, kontak, alamat, user, pass);
            }
        }
