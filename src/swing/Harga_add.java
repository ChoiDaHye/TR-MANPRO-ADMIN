...
public class Harga_add extends javax.swing.JFrame {
    ...
    void harga_tambah(String nama, float harga){
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Harga_add.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
